...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- link tải owlcarasel(chạy quảng cáo) https://www.landmarkmlp.com/js-plugin/owl.carousel/#demo -->
    ...
    <body class="antialiased">
        ...
        <!--End Login -->
            ...
            <!-- ------------Menu----------- -->
                ...
                <a class="navbar-brand" href="#">Sachtruyenne.com</a>
    ...
    <script type="text/javascript">
        $('#select-chapter').on( 'change', funtion(){
